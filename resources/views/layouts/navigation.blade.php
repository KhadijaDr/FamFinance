            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <i class="fas fa-home mr-1"></i> {{ __('Tableau de bord') }}
                    </x-nav-link>
                    
                    <x-nav-link :href="route('transactions.index')" :active="request()->routeIs('transactions.*')">
                        <i class="fas fa-exchange-alt mr-1"></i> {{ __('Transactions') }}
                    </x-nav-link>
                    
                    <x-nav-link :href="route('categories.index')" :active="request()->routeIs('categories.*')">
                        <i class="fas fa-tags mr-1"></i> {{ __('Catégories') }}
                    </x-nav-link>
                    
                    <x-nav-link :href="route('budgets.index')" :active="request()->routeIs('budgets.*')">
                        <i class="fas fa-chart-pie mr-1"></i> {{ __('Budgets') }}
                    </x-nav-link>
                    
                    <x-nav-link :href="route('bills.index')" :active="request()->routeIs('bills.*')">
                        <i class="fas fa-file-invoice-dollar mr-1"></i> {{ __('Factures') }}
                    </x-nav-link>
                    
                    <x-nav-link :href="route('financial-goals.index')" :active="request()->routeIs('financial-goals.*')">
                        <i class="fas fa-bullseye mr-1"></i> {{ __('Objectifs') }}
                    </x-nav-link>
                </div>
            </div>
